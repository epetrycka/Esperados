...
class EsperadosVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by EsperadosParser#forLoop.
    def visitForLoop(self, ctx:EsperadosParser.ForLoopContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsperadosParser#whileLoop.
    ...
    # Visit a parse tree produced by EsperadosParser#type.
    def visitType(self, ctx:EsperadosParser.TypeContext):
        return self.visitChildren(ctx)
